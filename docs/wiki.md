...
| [Textualização do MER](../src/uml/conceitual/2_textualizacao_MER.md) | Modelo Entidade-Relacionamento em texto |
...
| [Diagrama Conceitual (DER)](../src/uml/diagrama/DER.png) | Modelo conceitual (brModelo) |
| [Diagrama Lógico (MR)](../src/uml/logico/MR.png) | Modelo relacional (brModelo + PlantUML) |
